...
<footer>
<a href='../payment/Payment.php'><button  class="btn btn-warning" type='Submit' >Make Payment</button></a>
<a href='../viewcart/ViewCart.php'><button class="btn btn-warning" type='Submit'> View Cart </button></a>
</footer>
_END;
